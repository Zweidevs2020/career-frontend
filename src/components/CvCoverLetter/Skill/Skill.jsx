...
const Skill = () => {
  ...
  return (
    ...
    <div class='w-[98%] h-[200px] bg-yellow-500 mt-10  flex flex-col justify-center' >
      <h1 class='font-bold text-[18px] ml-3 ' >Skill*</h1>
      <Select placeholder='Select One' mode='multiple' allowClear style={{width:'90%',marginLeft:'10px'}} >
        {skill.map((skl,Index)=>{
