  ...
  return (
    <>
      <div class="flex flex-col justify-center">
        <h1 class="font-bold text-[18px] ml-3 ">
          What’s the best way for employers to contact you?
        </h1>
        <p class="ml-3 text-[#737373]">
      ...
      <div class="mt-2 flex flex-col justify-center ">
        ...
        <Input
          ...
          allowClear
          style={{ height: "45px", width: "95%", marginLeft: "12px" }}
        />
      </div>
      <div class="mt-2 flex flex-col justify-center ">
        ...
        <div class="h-[100px] w-[98%]  flex items-center justify-around ">
          <div class="h-[80px] w-[40%]  flex flex-col justify-center ">
            ...
            <Input
              ...
              allowClear
              style={{ height: "45px", width: "95%", marginLeft: "8px" }}
            />
          </div>
          ...
          <div class="h-[80px] w-[28%] flex flex-col justify-center ">
            ...
            <Input
              placeholder="e.g Cebu City, Cebu"
              allowClear
              style={{ height: "45px", width: "92%", marginLeft: "8px" }}
            />
          </div>
        </div>
      </div>
      <div class="mt-2 flex flex-col  ">
        ...
        <TextArea
          ...
          style={{ width: "95%", marginLeft: "14px" }}
        />
      </div>
    </>
  );
