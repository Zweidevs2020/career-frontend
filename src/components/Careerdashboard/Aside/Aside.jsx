...
const Aside = () => {
  return (
    <>
      <div
        className="logo"
        class="h-[90px] w-[100%] flex items-center justify-center"
      >
        <img src={mycareer} class="h-[45px] lg:h-[35px]" />
      </div>
      <div
        className="itemslist"
        class="h-[280px] w-[100%]  flex flex-col items-center justify-center gap-[5px]"
      >
        <div class="h-[40px] w-[90%] md:w-[95%]  flex items-center  justify-around">
          ...
          <div class="h-[30px] w-[60%] lg:w-[65%] flex items-center justify-start">
            <p class="text-[#1476B7] text-md    lg:text-[14px] font-bold">
              Overview
            </p>
          </div>
        </div>
        <div class="h-[40px] w-[90%] md:w-[95%] flex items-center  justify-around ">
          ...
          <div class="h-[30px] w-[60%] lg:w-[65%] flex items-center justify-start">
            <p class="text-[#737373] text-md font-lighter lg:text-[12px] ">
              CAO Calculator
            </p>
          </div>
        </div>
      ...
      <div
        className="img"
        class="h-[201px] w-[100%]  flex items-center justify-center"
      >
        <img src={Group} class="h-[190px] lg:h-[130px]" />
      </div>
      <div
        className="button"
        class="h-[80px] w-[100%]  flex items-center justify-center"
      >
