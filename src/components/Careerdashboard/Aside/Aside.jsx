  ...
  return (
    ...
    <div className='itemslist' class='h-[280px] w-[100%]  flex flex-col items-center justify-center gap-[5px]' >
        <div class='h-[40px] w-[90%]  flex items-center  justify-around'>
            ...
            <div class='h-[30px] w-[60%] flex items-center justify-start' >
            <p class='text-[#1476B7] text-md font-bold' >Overview</p>   
            </div>
        </div>
        <div class='h-[40px] w-[90%]  flex items-center  justify-around'>
            <div class='h-[30px] w-[15%] flex items-center justify-center' >
            ...
            <div class='h-[30px] w-[60%] flex items-center justify-start' >
            <p class='text-[#737373] text-md font-lighter' >CAO Calculator</p>   
            </div>
        </div>
        <div class='h-[40px] w-[90%]  flex items-center  justify-around'>
            <div class='h-[30px] w-[15%] flex items-center justify-center' >
            ...
            <div class='h-[30px] w-[60%]  flex items-center justify-start' >
            <p class='text-[#737373] text-md font-lighter' >My Goals</p>   
            </div>
        </div>
        <div class='h-[40px] w-[90%]  flex items-center  justify-around'>
            <div class='h-[30px] w-[15%]  flex items-center justify-center' >
            ...
            <div class='h-[30px] w-[60%]  flex items-center justify-start' >
            <p class='text-[#737373] text-md font-lighter' >CV/Cover Later</p>   
            </div>
        </div>
        <div class='h-[40px] w-[90%]  flex items-center  justify-around'>
            <div class='h-[30px] w-[15%]  flex items-center justify-center' >
            ...
            <div class='h-[30px] w-[60%]  flex items-center justify-start' >
            <p class='text-[#737373] text-md font-lighter' >Self Assessment</p>   
            </div>
        </div>
        <div class='h-[40px] w-[90%]  flex items-center  justify-around'>
            <div class='h-[30px] w-[15%]  flex items-center justify-center' >
            ...
            <div class='h-[30px] w-[60%]  flex items-center justify-start' >
            <p class='text-[#737373] text-md font-lighter' >My Study </p>   
            </div>
        </div>
    </div>
    <div className='img' class='h-[201px] w-[100%]  flex items-center justify-center' >
        <img src={Group}  class='h-[190px]' />
    </div>
