...
const Selfnavbar = () => {
  return (
    ...
    <p class='text-[#1476B7] text-[22px]' >Hello <strong> Bruno Fernandes</strong>, welcome back!</p>
     ...
     <div class='h-[80px] w-[45%] mr-2  flex items-center justify-end' >
        <div class='bg-[#1476B7] h-[65px] w-[60%] rounded-xl flex items-center justify-around'>
            <img src={pf} class='h-[55px]' />
